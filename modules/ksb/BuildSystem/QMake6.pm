...
package ksb::BuildSystem::QMake6 0.10;
...
sub absPathToQMake
{
    my @possibilities = qw/qmake-qt6 qmake6 qmake-mac qmake/;
...
{
    my $self = assert_isa(shift, 'ksb::BuildSystem::QMake6');
    my $module = $self->module();
    ...
    return await_exitcode(
        run_logged_p($module, 'qmake6', $builddir,
